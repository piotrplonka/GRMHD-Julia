...
function PtoU(x::AbstractVector, buffer::AbstractVector,gcov::Matrix{Float64})
...
function PtoFx(x::AbstractVector, buffer::AbstractVector,gcov::Matrix{Float64})
...
function PtoFy(x::AbstractVector, buffer::AbstractVector,gcov::Matrix{Float64})
...
function PtoFz(x::AbstractVector, buffer::AbstractVector,gcov::Matrix{Float64})
...
function UtoP(U::AbstractVector, initial_guess::AbstractVector, gcov::Matrix{Float64})
    #Some values
