...
#UtoP(U1, P1*1.1,  Kerr_Schild_metric_cov(N1_grid[i], N2_grid[j], N3_grid[k], a), eos::Polytrope)

vecor = [1,2,5,14,35,1,1,1]
println(Lorentz_factor(vecor, Kerr_Schild_metric_cov(1.0, 2.0, 3.0, a), eos::Polytrope))
println(sqrt(5^2 + 14^2 +35^2 +1))
